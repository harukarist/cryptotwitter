    ...
    <section class="c-section">
      ...
      <div class="c-section__contents">
        ...
        <ol class="c-list__ordered">
          ...
          <li>
            ...
            <ol class="c-list__ordered">
              ...
              <li>反社会的勢力等（暴力団、暴力団員、右翼団体、反社会的勢力、その他これに準ずる者を意味します。以下同じ。）である、または資金提供その他を通じて反社会的勢力等の維持、運営もしくは経営に協力もしくは関与する等反社会的勢力との何らかの交流もしくは関与を行っていると当社が判断した場合</li>
        ...
        <ol class="c-list__ordered">
          ...
          <li>ユーザーIDおよびパスワードの管理不十分、使用上の過誤、第三者の使用等による損害の責任はユーザーが負うものとし、当社は一切の責任を負いません。</li>
        </ol>
        ...
        <ol class="c-list__ordered">
          ...
          <li>ユーザーが利用期間の途中で解約をした場合その他理由の如何を問わず、当社はユーザーから支払を受けた利用料金を返還する義務を負わないものとします。</li>
        </ol>
        ...
        <ol class="c-list__ordered">
          ...
          <li>Twitterその他本サービスと連携するサービス（以下、「連携サービス」といいます。）の利用規約等の連携サービスの利用に関する規則・ルールに違反する行為</li>
        ...
        <ol class="c-list__ordered">
          <li>
            ...
            <ol class="c-list__ordered">
              ...
              <li>Twitterその他の連携サービスに、トラブル、サービス提供の中断または停止、本サービスとの連携の停止、仕様変更等が生じた場合</li>
              <li>本サービスの運用上、技術上またはユーザーの利便のため一時的な本サービスの提供の中断または停止が必要と当社が判断した場合</li>
              <li>その他、当社が本サービスの提供が困難と判断した場合</li>
            </ol>
          </li><li>当社は、本サービスの提供の停止または中断により、ユーザーまたは第三者が被ったいかなる不利益または損害についても、一切の責任を負わないものとします。</li>
        </ol>
        ...
        <ol class="c-list__ordered">
          ...
          </li><li>当社は、本条に基づき当社が行った行為によりユーザーに生じた損害について、一切の責任を負いません。</li>
        </ol>
        ...
        <ol class="c-list__ordered">
          ...
          <li>ユーザーは連携サービスの利用に関する規則・ルールを自己の費用と責任で遵守するものとし、ユーザーと当該連携サービスを運営する第三者との間で紛争等が生じた場合でも、当社は当該紛争等について一切の責任を負いません。</li>
        </ol>
        ...
        <ol class="c-list__ordered">
          ...
          <li>当社は、本サービスにかかる事業を第三者に譲渡（事業譲渡、会社分割その他態様の如何を問わないものとします。）した場合には、当該譲渡に伴い本規約に基づく契約上の地位、本規約に基づく権利および義務ならびにユーザーの登録情報その他の顧客情報を当該譲渡の譲受人に譲渡することができるものとし、ユーザーは、かかる譲渡につき本項において予め同意したものとします。</li>
        </ol>
