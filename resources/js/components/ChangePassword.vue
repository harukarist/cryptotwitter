...
export default {
  ...
  methods: {
    ...
    checkChangePassForm() {
      ...
      const results = this.passwordErrors.concat(this.newPasswordErrors, this.confirmErrors)
    ...
    async changePassword() {
      ...
      const response = await axios.post('/api/password/change', this.changePassForm)
