        ...
        <div class="c-form__wrapper">
                    <form method="POST" action="{{ route('password.update') }}" class="c-form--small">
                        ...
                        <div class="c-form__group">
                            ...
                            <input id="email" type="email" class="form-control c-input c-input--large @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="c-form__group">
                            ...
                            <input id="password" type="password" class="form-control c-input c-input--large @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="c-form__group">
                            ...
                            <input id="password-confirm" type="password" class="form-control c-input c-input--large" name="password_confirmation" required autocomplete="new-password">
                        </div>
